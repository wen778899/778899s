...
import { RefreshCw, Trophy, ChevronRight, Zap } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen max-w-md mx-auto bg-gray-50 shadow-2xl overflow-hidden pb-10">
      ...
      <div className="bg-indigo-600 px-4 py-4 flex justify-between items-center text-white shadow-lg sticky top-0 z-50">
        ...
        <button onClick={fetchData} className="p-2 bg-indigo-500 rounded-full hover:bg-indigo-400 transition">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="px-4 py-3 bg-gray-50 border-b font-bold text-gray-600 text-sm">往期记录</div>
          <div className="divide-y divide-gray-100">
            {history.map((item) => (
              <div key={item.issue} className="p-3 flex items-center justify-between hover:bg-gray-50">
